...
public:
	Int32Func(const char* name = "f") : Func(FunctionType::getInt32Ty(getGlobalContext()), name) {}
};

class VoidFunc : public Func {
public:
	VoidFunc(const char* name = "f") : Func(FunctionType::getVoidTy(getGlobalContext()), name) {}
};
